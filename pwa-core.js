...
document.addEventListener('DOMContentLoaded', () => {
  ...
  <div id="pwa-card">
    ...
    <div id="pwa-block-android" hidden>
      ...
      <div id="pwa-install-content">
        ...
        <div class="pwa-after-note">
          ✅ Sau khi cài xong, mở từ màn hình chính để sử dụng ➜ không cần vào link này nữa.<br>
    ...
    <div id="pwa-block-ios" hidden>
      ...
      <div class="pwa-after-note">✅ Sau khi cài xong, mở từ màn hình chính để sử dụng ➜ không cần vào link này nữa.<br>🗑️ Khi không còn dùng, để gỡ cài đặt: Nhấn giữ icon app ➜ <b>Xoá bookmark</b></div>
